...
import com.example.springassignment2.SpringAssignment2.service.CommuteServiceImpl;
...
public class CommuteServiceTests
{
    ...
    @Test
    public void givenCommuteObject_whenSaveCommute_thenReturnCommuteObject(){
    ...
    @Test
    public void givenCommuteId_whenGetCommuteById_thenReturnCommuteObject(){
        // given
    ...
    @Test
    public void givenCommuteId_whenDeleteCommute_thenNothing(){
        // given - precondition or setup
        int commuteId = 1;
    ...
    @Test
    public void givenJobId_whenGetCommutesbyJobId_thenReturnCommuteObject(){
